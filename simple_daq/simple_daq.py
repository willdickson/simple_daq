...
"""
 ...
 A simple module for capturing data from comedi supported data
 ...
 basic data acquisition function "acquire_data" there are functions
 for parsing text based configuration files and handling command-line
 options.
